 ...
 */
export declare type Protocols = 'SAML' | 'OIDC';
/**
 * The language used for the UI.
 */
export declare type Languages = 'it' | 'en' | 'de' | 'es' | 'fr';
/**
 ...
 */
export declare type ConfigurationPOST = {
    method: 'POST';
    fieldName: string;
 ...
 */
export declare type Types = 'modal' | 'dropdown';
/**
 ...
 * @private
 */
export declare type RegisteredProviderRecord = Omit<ProviderRecord, 'protocols'> & {
    protocols: Protocols[];
    active: boolean;
};
export declare type SPIDButtonProps = {
    /**
     ...
     */
    onProviderClicked?: (providerEntry: ProviderRecord, loginURL: string | undefined, event: React.MouseEvent<HTMLAnchorElement, MouseEvent> | React.MouseEvent<HTMLButtonElement, MouseEvent>) => void;
    /**
